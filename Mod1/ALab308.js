...
console.log( ` Accoring to the funtion these numbers are divisible by 25    ${areAllDivisibleBy5}`);


// check if first is larger than last//
const isFirstLargerThanLast = n1 > n4;
console.log( `n1 is larger than n4 10 is greater than 5 ${isFirstLargerThanLast}`);
...
const perdictedMPG = [30,28,23]

// How many gallons of fuel will you need for the entire trip?

const gallonsNeeded = totalmiles/perdictedMPG

console.log(totalmiles/fuelPerGalon)
